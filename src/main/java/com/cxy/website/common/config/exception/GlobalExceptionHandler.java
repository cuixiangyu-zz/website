package com.cxy.website.common.config.exception;
...
public class GlobalExceptionHandler {
	...
	@CrossOrigin(value = "*")
	public JSONObject httpRequestMethodHandler(HttpServletResponse res,HttpServletRequest req ) {
		...
		jsonObject.put("code", ErrorEnum.E_4004.getErrorCode());
		jsonObject.put("msg", ErrorEnum.E_4004.getErrorMsg());
		return jsonObject;
	}
	...
	public JSONObject unauthorizedExceptionHandler() {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("code", ErrorEnum.E_5001.getErrorCode());
		jsonObject.put("msg", ErrorEnum.E_5001.getErrorMsg());
		return jsonObject;
	}
