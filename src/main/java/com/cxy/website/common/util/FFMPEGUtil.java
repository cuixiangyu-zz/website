...
public class FFMPEGUtil {
    ...
    public static void getVideoPic(String videoAddr,String picAddr)throws Exception {
        ...
        while(flag){
            ...
            while (true){
                ...
                if(temp == videoCodecCtx)
                {
                    ...
                    save_frame(pFrameRGB,index,picAddr);
                    index++;
     ...
     * @throws IOException
     */
    static void save_frame(AVFrame pFrame,int count,String picAddr) throws IOException {
